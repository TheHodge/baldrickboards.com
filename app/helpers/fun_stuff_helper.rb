module FunStuffHelper
  ...
  def baldrick_buddy_platform_icon(platform)
    svg = case platform.to_s
          when 'mac'
            <<~SVG
          ...
          when 'windows'
            <<~SVG
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M3 5.5 11 4.2v7.3H3V5.5zm0 13L11 19.8v-7.1H3v5.8zM12.5 4l8.5-1.2v8.7h-8.5V4zm0 16.1 8.5 1.2v-8.6h-8.5v7.4z"/>
              </svg>
            SVG
          else
            <<~SVG
